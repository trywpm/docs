...
- New to wpm? Start with the [getting started](/getting-started/first-project)
  walkthrough.
...
- Looking up a term? See the [glossary](/reference/glossary).
...
| Command | Description |
| --- | --- |
| [`wpm auth`](./auth/index.mdx) | Authenticate with the wpm registry |
| [`wpm init`](./init.mdx) | Initialize a new WordPress package or init wpm in existing project |
| [`wpm install`](./install.mdx) | Install project dependencies and add new packages |
| [`wpm ls`](./ls.mdx) | List installed dependencies |
| [`wpm outdated`](./outdated.mdx) | Check for outdated dependencies |
| [`wpm publish`](./publish.mdx) | Publish a package to the wpm registry |
| [`wpm uninstall`](./uninstall.mdx) | Remove dependencies from the project |
| [`wpm whoami`](./whoami.mdx) | Display the current user |
| [`wpm why`](./why.mdx) | Show why a package is installed |
