...
<Cards>
  <Card
    ...
    description="Understand the manifest in detail."
  />
  <Card
    icon={<GitBranch />}
    title="CI/CD guide"
    href="/guides/ci"
    description="Run wpm in CI with reproducible installs."
  />
  <Card
    icon={<KeyRound />}
    title="Authentication"
    href="/guides/authentication"
    description="Manage tokens and multiple accounts."
  />
  <Card
    icon={<Layers />}
    title="Package types"
    href="/fundamentals/package-types"
    description="The plugin, theme, and mu-plugin distinctions."
  />
  <Card
    icon={<Terminal />}
    title="CLI reference"
    href="/reference/cli"
    description="Browse every command and flag."
  />
  <Card
    icon={<FolderPlus />}
    title="Adopt wpm in an existing project"
    href="/reference/cli/init"
    description="Use wpm init --existing to wrap an existing plugin or theme."
  />
</Cards>
