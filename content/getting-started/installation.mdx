...
internet. Microsoft has the
[full reference](https://learn.microsoft.com/powershell/module/microsoft.powershell.security/set-executionpolicy)
on Set-ExecutionPolicy.
