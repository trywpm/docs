...
<Callout type="idea" title="What's coming next">
...
<Cards>
  <Card
    icon={<ArrowLeftRight />}
    title="wp-to-wpm"
    href="https://github.com/trywpm/wp-to-wpm"
    description="Migrate plugins and themes from WordPress.org SVN to the wpm registry. Designed to run as a GitHub Action."
  />
  <Card
    icon={<Cog />}
    title="setup-wpm"
    href="https://github.com/trywpm/setup-wpm"
    description="A GitHub Action that installs and configures the wpm CLI for your CI/CD pipelines."
  />
</Cards>
...
<Cards>
  <Card
    ...
    description="Get wpm on your machine in a single command."
  />
  <Card
    icon={<Rocket />}
    title="First project"
    href="/getting-started/first-project"
    description="A ten-minute walkthrough from empty directory to working project."
  />
  <Card
    icon={<Boxes />}
    title="Dependencies"
    href="/fundamentals/dependencies"
    description="The full reasoning behind exact-version pinning."
  />
  <Card
    icon={<Cloud />}
    title="wpm registry"
    href="/fundamentals/registry"
    description="How it stores manifests and verifies provenance."
  />
</Cards>
