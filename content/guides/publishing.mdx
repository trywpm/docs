...
- [`wpm publish`](../reference/cli/publish): every flag, with troubleshooting.
- [wpm registry](../fundamentals/registry): tags, visibility, and the
  difference between `private: true` and `--access private`.
- [Authentication](authentication): tokens and CI patterns.
- [`.wpmignore`](../fundamentals/wpmignore): syntax for the exclusion file.
- [`wpm.json`](../fundamentals/wpm-json): the manifest schema.
