...
import { Cloud, Download, KeyRound, Terminal } from 'lucide-react';
...
<Cards>
  <Card
    ...
    description="How the install script works."
  />
  <Card
    icon={<KeyRound />}
    title="Authentication"
    href="/guides/authentication"
    description="The token lifecycle."
  />
  <Card
    icon={<Terminal />}
    title="CLI reference"
    href="/reference/cli"
    description="The full list of global flags and environment variables."
  />
  <Card
    icon={<Cloud />}
    title="wpm registry"
    href="/fundamentals/registry"
    description="Dist tags and visibility settings used by `wpm publish`."
  />
</Cards>
