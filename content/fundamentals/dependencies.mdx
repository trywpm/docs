...
import { Cpu, Lock, PackageMinus, PackagePlus } from 'lucide-react';
...
<Cards>
  <Card
    ...
    description="The command that reads and writes the dependency maps."
  />
  <Card
    icon={<PackageMinus />}
    title="wpm uninstall"
    href="/reference/cli/uninstall"
    description="Remove entries and reconcile disk."
  />
  <Card
    icon={<Lock />}
    title="wpm.lock"
    href="/fundamentals/wpm-lock"
    description="The resolved snapshot that pairs with the manifest."
  />
  <Card
    icon={<Cpu />}
    title="Runtime compatibility"
    href="/fundamentals/runtime"
    description="`requires` constraints, distinct from dependency specifiers."
  />
</Cards>
