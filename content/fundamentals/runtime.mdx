...
- [`wpm.json` reference](wpm-json): the full schema and all field rules.
- [`wpm install`](../reference/cli/install): where the strict check runs.
- [Dependencies](dependencies): the difference between dependency specifiers
