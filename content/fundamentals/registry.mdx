...
import { FileJson, KeyRound, PackagePlus, Upload } from 'lucide-react';
...
<Cards>
  <Card
    ...
    description="How credentials are obtained and stored."
  />
  <Card
    icon={<Upload />}
    title="wpm publish"
    href="/reference/cli/publish"
    description="Upload new versions and set the dist tag and visibility."
  />
  <Card
    icon={<PackagePlus />}
    title="wpm install"
    href="/reference/cli/install"
    description="Read manifests and download tarballs from the registry."
  />
  <Card
    icon={<FileJson />}
    title="wpm.json"
    href="/fundamentals/wpm-json"
    description="The `private` flag, distinct from registry visibility."
  />
</Cards>
