...
<Cards>
  <Card
    ...
    description="The request that the lockfile records the answer to."
  />
  <Card
    icon={<Boxes />}
    title="Dependencies"
    href="/fundamentals/dependencies"
    description="How the request is expressed."
  />
  <Card
    icon={<PackagePlus />}
    title="wpm install"
    href="/reference/cli/install"
    description="The command that writes the lockfile."
  />
  <Card
    icon={<List />}
    title="wpm ls"
    href="/reference/cli/ls"
    description="Inspect the installed tree from the lockfile."
  />
  <Card
    icon={<CircleHelp />}
    title="wpm why"
    href="/reference/cli/why"
    description="Trace a package back to its root in the lockfile."
  />
</Cards>
